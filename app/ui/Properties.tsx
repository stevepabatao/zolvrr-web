              ...
              <CarouselItem key={index} className="basis-3.5 md:basis-1/8 lg:basis-1/4 ">
                <div className="p-2">
                    <Card className="w-full max-w-[355px] mx-auto shadow-2xl">
                        ...
                        <CardContent>
                            <div className="flex w-full text-sm tracking-wider mt-2 mb-2  ≈">
                              <div className="basis-1/2  text-left font-bold">Price</div> 
                              <div className="basis-1/2 text-right">P20000000</div>
                            </div>

                    ...
                    <div className="flex flex-wrap gap-5 lg:gap-10 justify-center">
                        ...
                        <div className="flex flex-col items-center">
                            <Image className="mb-1 rounded-xl" src="https://images.pexels.com/photos/3935333/pexels-photo-3935333.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                alt="Property Image" width={279} height={235} />
                            <div className="border border-none shadow-2xl rounded-lg mt-[-40px] w-[245px] bg-white p-5 flex flex-col items-center justify-center">
                                <h3>For Rent</h3>
